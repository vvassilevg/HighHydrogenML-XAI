...
class CounterfactualExplanations:
    ...
    #MODIFICATIONS INTRODUCED BY: VALENTIN VASSILEV-GALINDO
    ### Argument print_dfs=True
    ### Added conditional "if print_dfs" to retrieve list instead of printing it
    def visualize_as_dataframe(self, display_sparse_df=True,
                               show_only_changes=False, print_dfs=True):
